...
namespace Stushbr.Data.DataAccess.Sql.Migrations
{
    ...
    [Migration("20231114195404_RefactorModels")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Stushbr.Domain.Models.Items.Item", b =>
                {
                    ...
                    b.Property<DateTime>("AvailableSince")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 11, 14, 19, 54, 4, 721, DateTimeKind.Utc).AddTicks(3813));
            ...
            modelBuilder.Entity("Stushbr.Domain.Models.Items.TelegramItemChannel", b =>
                {
                    ...
                    b.HasKey("TelegramItemId", "ChannelId");
            ...
            modelBuilder.Entity("Stushbr.Domain.Models.Items.TelegramItemChannel", b =>
                {
                    b.HasOne("Stushbr.Domain.Models.Items.TelegramItem", "TelegramItem")
                        .WithMany("Channels")
